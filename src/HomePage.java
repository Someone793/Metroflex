...
public class HomePage extends JFrame {
    public HomePage() {
        ...
        buttonPanel.setLayout(new GridLayout(7, 1, 10, 10)); // Increased rows to 7
        ...
        JButton btnMonthlyReport = createStyledButton("Monthly Report", buttonColor, buttonHoverColor, textColor);
        JButton btnExit = createStyledButton("Exit", exitButtonColor, exitHoverColor, Color.WHITE);
        ...
        buttonPanel.add(btnMonthlyReport); // Added new button here
        ...
        btnMonthlyReport.addActionListener(e -> openWindow(new MonthlyReportForm())); // Action for new button
